...
const Production = () => {
			...
			case 'overview':
				return (
					<OverviewContent
						...
						productionLogs={productionLogData}
					/>
				);
			case 'Downtime':
	...
	return (
		<Layout>
			<PageHeader title="Production" tabs={tabs} onTabChange={handleTabChange} />
			{logsModalOpen && (
				<Modal title="Production Log Modal" isOpen={logsModalOpen} onClose={toggleLogsModal}>
					{logsModalMode === 'view' && (
