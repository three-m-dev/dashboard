...
const Hero = () => {
  return (
    <section className="bg-background mt-12">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center sm:py-12 lg:py-20 lg:pb-56 lg:px-12">
        <Link
          to="/bulletin"
        ...
        <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
          ...
          <Link
            ...
            target="_blank"
            className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg border border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-100"
          >
            <svg
